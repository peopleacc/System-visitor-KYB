                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-5">
                   ...
                   p             required
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"  name="captcha" class="form-control p-1 border border-gray-400" required>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-3 cursor-pointer group">
                            <input type="checkbox" name="remember" class="w-4 h-4 rounded border-gray-300 text-red-500 focus:ring-red-400" />
                            <span class="text-sm text-gray-600 group-hover:text-gray-800 transition">Remember me</span>
                        </label>
                        <a href="#" class="text-sm text-red-500 hover:text-red-600 font-medium transition">Forgot password?</a>
                    </div>
