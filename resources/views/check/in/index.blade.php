                ...
                <div class="p-6">
                    @if ($checkin)
                        <div class="text-center">
                            ...
                            <p class="text-lg font-bold text-green-600">Check-In Berhasil</p>
                            <p class="text-sm text-green-500 mt-1">Visitor telah melakukan check-in</p>
                            <p class="text-lg text-green-500 mt-1">ID kartu Visitor: </br>{{ $checkin->barcode_nama }}</p>
                        </div>
                    @else
                        <div class="text-center">
                            ...
                            <p class="text-lg font-bold text-gray-400">Silakan Scan Barcode Untuk Check-In</p>
                        </div>
                    @endif
                    {{-- Status Display --}}
